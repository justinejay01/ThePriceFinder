...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=138421462ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pricefinder&table=accounts">`pricefinder`.`accounts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pricefinder&table=products">`pricefinder`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pricefinder&table=search">`pricefinder`.`search`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=itel203finals&table=pag-ibig">`itel203finals`.`pag-ibig`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=itel203finals&table=gsis">`itel203finals`.`gsis`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=itel203finals&table=accounts">`itel203finals`.`accounts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=itel203&table=pag-ibig">`itel203`.`pag-ibig`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=itel203&table=psa">`itel203`.`psa`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=itel203&table=gsis">`itel203`.`gsis`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=itel203&table=sss">`itel203`.`sss`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="3f667b7875727764674d272765714a48">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="pricefinder" targettable="products">
            ...
            Queried time
                            ...
                            targetdb="pricefinder" targettable="search">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `pricefinder`.`search` ( `name` VARCHAR(255) NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pricefinder" targettable="search">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `search`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pricefinder" targettable="search">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `search` (`name`) VALUES (&#039;jj&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="pricefinder" targettable="search">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `search` (`name`) VALUES (&#039;1&#039;), (&#039;2&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pricefinder" targettable="search">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `search` (`name`) VALUES (&#039;2&#039;), (&#039;2&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pricefinder" targettable="products">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `products`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="pricefinder" targettable="accounts">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
