...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <h1 class="mt-6">Current version: 1.0-alpha1</h1>
                <h3>Features:</h3>
                <ul>
                    <li>Search product price and availability by product name or barcode.</li>
                    <li>Account authentication (Login and Register) for administrator and for future use.</li>
